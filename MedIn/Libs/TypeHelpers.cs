...
namespace Libs
{
	public static class TypeHelpers
	{
        ...
        public static string GetEntitySetName(Type entityType, DbContext db)
		{
            ...
            var container = ((IObjectContextAdapter)db).ObjectContext.MetadataWorkspace.GetEntityContainer(((IObjectContextAdapter)db).ObjectContext.DefaultContainerName, DataSpace.CSpace);
		...
		public static IEnumerable GetEntitySet(DbContext db, Type type)
		{
            var m = db.GetType().GetMethods().First(info => info.Name == "Set");//CreateObjectSet

...
{
    public partial class CrewController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public CrewController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected CrewController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public CrewController Actions { get { return MVC.Crew; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Crew";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Crew";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CrewController : CMS.Areas.Admin.Controllers.CrewController
    {
        public T4MVC_CrewController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, KonigLabs.Models.CrewMember entity, System.Web.Mvc.FormCollection collection, string editViewName);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(KonigLabs.Models.CrewMember entity, System.Web.Mvc.FormCollection collection, string editViewName)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);

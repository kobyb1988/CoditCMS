...
jQuery.fn.fs_gallery = function(fs_options) {
	...
	$('.fs_thmb_viewport').width($(window).width()-$fs_title.width()-28);
	...
	$('.fs_thmb_viewport').width($(window).width()-$fs_title.width()-28)
		.mouseenter(function(){
			...
			var correction = $fs_title.width()+28;

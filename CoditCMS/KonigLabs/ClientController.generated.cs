...
namespace CMS.Areas.Admin.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ClientController : CMS.Areas.Admin.Controllers.ClientController
    {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, KonigLabs.Models.Client entity, System.Web.Mvc.FormCollection collection, string editViewName);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(KonigLabs.Models.Client entity, System.Web.Mvc.FormCollection collection, string editViewName)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);

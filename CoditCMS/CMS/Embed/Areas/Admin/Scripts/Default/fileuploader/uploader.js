...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
            ...
            (!this._options.button ? '<div class="qq-upload-button"><div><span class="icon-publish"></span>{uploadButtonText}</div></div>' : '') +
        ...
        fileTemplate: '<li>' +
            ...
            '<a class="qq-upload-cancel" href="#"><span class="icon-cancel"></span>{cancelButtonText}</a>' +

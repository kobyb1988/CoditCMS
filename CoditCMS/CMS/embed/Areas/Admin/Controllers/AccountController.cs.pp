...
{
    [HandleError]
    public partial class AccountController : CoditController
    {
                        ...
                        if (model.NewPassword != null)
                        {
                            if (model.NewPasswordConfirm != null)
                            {
                                if (model.NewPassword == model.NewPasswordConfirm)
                                {
                                    ...
                                    return RedirectToAction(collection.GetValue(FieldsNames.SaveButton) != null ? "Index" : "Edit?providerUserKey="+model.ProviderUserKey.ToString());
                                }

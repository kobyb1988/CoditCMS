...
using Libs;
using CheckboxSettings = CMS.PagesSettings.Lists.CheckboxSettings;
using CurrencySettings = CMS.PagesSettings.Lists.CurrencySettings;
using DateSettings = CMS.PagesSettings.Lists.DateSettings;
using ImageSettings = CMS.PagesSettings.Lists.ImageSettings;
using StringSettings = CMS.PagesSettings.Lists.StringSettings;
...
namespace CMS.PagesSettings
{
	public class Settings
	{
		...
		{
			return new Forms.StaticSettings();
		}
